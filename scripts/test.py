...
# Load the image
image = Image.open('../textures/board_complete1.png')  # Replace with your image file name
...
white_square = [238, 238, 210]  # Approximate RGB for white squares
...
mask = ~(
    ((np.abs(data[:, :, :3] - white_square) < 5).all(axis=-1)) |  # White square threshold
